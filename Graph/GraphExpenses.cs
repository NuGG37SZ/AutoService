...
{
    public partial class GraphExpenses : Form
    {
        public GraphExpenses()
        {
            InitializeComponent();
        }

        private void GraphExpenses_Load(object sender, EventArgs e)
        {
            getExpensesCurrentYear();
            CreateChart(dataGridView1, "Расходы за текущий год", "Expenses");
        }

        private void getExpensesCurrentYear()
        {
            DbConnect.Connect();
