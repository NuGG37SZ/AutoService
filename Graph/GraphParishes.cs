...
{
    public partial class GraphParishes : Form
    {
        public GraphParishes()
        {
            InitializeComponent();
        }

        private void GraphParishes_Load(object sender, EventArgs e)
        {
            getComingCurrentYear();
            CreateChart(dataGridView1, "Приходы за текущий год", "Coming");
        }

        private void getComingCurrentYear()
        {
            DbConnect.Connect();
